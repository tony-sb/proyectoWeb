        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="Controlador?accion=home"><i ></i> Seguir Comprando</a>
                    </li>
                            ...
                            <c:forEach var="car" items="${carrito}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="img/producto${car.getIdProducto()}.jpg" width="100" height="100">
                                    </td>
